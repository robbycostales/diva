    ...
    def update(self,
        ...
        if rlloss_through_encoder:
            ...
            utl.recompute_embeddings(policy_storage, 
                                     ...
                                     sample=False, 
                                     update_idx=0,
                                     detach_every=self.args.vae.tbptt_stepsize 
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                env_latents = EnvLatents(
                    z_samples=latent_sample_batch,
                    z_means=latent_mean_batch,
                    z_logvars=latent_logvar_batch)
                latent_batch = utl.get_zs_for_policy(args=self.args, env_latents=env_latents)
