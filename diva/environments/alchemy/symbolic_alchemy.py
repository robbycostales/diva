...
from dm_alchemy import event_tracker, symbolic_alchemy_trackers
...
def get_symbolic_alchemy_level(
  ...
  if 'random_bottleneck' in level_name:
    graph_gen = lambda: seeded_rand_graph(graph_distr(possible_constraints()))  # noqa: E731
  ...
  if 'rotation' in level_name:
    ...
    rotation_gen = lambda: np.eye(3)  # noqa: E731
